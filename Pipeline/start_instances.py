...
instance_prod = nova.servers.create(name="prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='PRJ_Group13', userdata=userdata_prod, nics=nics, security_groups=secgroups)
instance_dev = nova.servers.create(name="dev_server_"+str(identifier), image=image, flavor=flavor, key_name='PRJ_Group13', userdata=userdata_dev, nics=nics, security_groups=secgroups)
